...
namespace URC.Core
{
    ...
    public class Motor : MonoBehaviour
    {
        ...
        public float Speed
        {
            get { return m_rigidbody.linearVelocity.magnitude; }
        }
        ...
        {
            get { return new Vector3(m_rigidbody.linearVelocity.x, 0, m_rigidbody.linearVelocity.z); }
        }
        ...
        {
            get { return new Vector3(m_rigidbody.linearVelocity.x, 0, m_rigidbody.linearVelocity.z).magnitude; }
        }
        ...
        {
            get { return m_rigidbody.linearVelocity.y; }
        }
